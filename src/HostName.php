...
class HostName
{
    ...
    private const HOSTS = [
        ...
        self::PERKS => [
            'production' => 'https://perks.serato.com',
            'staging' => 'https://perks.serato.xyz',
            'preprod' => 'https://perks.serato.biz',
            'dev' => 'http://192.168.4.14:8788/',
            'test' => 'https://test-' . self::TEST_STACK_NUM_PLACEHOLDER . '-perks.serato.net',
            'sws_host_key' => 'perks'
        ],
    ];
